...
export default function LoginPage() {
    ...
    return (
        <div className="py-20 px-4 flex justify-center">
            <form onSubmit={handleLogin} className="space-y-6 backdrop-blur p-8 rounded-lg shadow-lg w-full max-w-sm border border-white/10">
                <h1 className="text-2xl font-extrabold text-white text-center">Login to sprkix</h1>
                <input
                    type="email"
                    placeholder="Email"
                    value={email}
